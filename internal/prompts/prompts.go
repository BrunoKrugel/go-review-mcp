...
func GetReviewCodePrompt() Prompt {
	return Prompt{
		Name:        "review_code",
		Description: "Comprehensive Go code review based on Google and Uber style guides",
		Arguments: []PromptArgument{
			{
				Name:        "code",
...
func GetCheckNamingPrompt() Prompt {
	return Prompt{
		Name:        "check_naming",
		Description: "Review Go code naming conventions",
		Arguments: []PromptArgument{
			{
				Name:        "code",
...
func GetCheckErrorHandlingPrompt() Prompt {
	return Prompt{
		...
		Description: "Review Go code error handling patterns",
		Arguments: []PromptArgument{
			{
				Name:        "code",
...
func GetCheckConcurrencyPrompt() Prompt {
	return Prompt{
		...
		Description: "Review Go code concurrency patterns",
		Arguments: []PromptArgument{
			{
				Name:        "code",
...
func GetCheckTestingPrompt() Prompt {
	return Prompt{
		Name:        "check_testing",
		Description: "Review Go test code quality",
		Arguments: []PromptArgument{
			{
				Name:        "code",
...
func GetCheckInterfacesPrompt() Prompt {
	return Prompt{
		...
		Description: "Review Go interface design and usage",
		Arguments: []PromptArgument{
			{
				Name:        "code",
...
func GetPromptByName(name string) (Prompt, bool) {
